...
class LadlePreparationBayCam1 extends StatelessWidget {
  const LadlePreparationBayCam1({Key? key}) : super(key: key);
      ...
      body: Column(
        children: [
          Container(
            ...
            child: TextRecognizerView("Ladle Preparation Bay","1"),
          ),
          Expanded(
